...
Scientific research is becoming increasingly computational.
...
Processing huge datatest or running calculations of this complexity requires a lot of computing power, more than an individual laptop or work station can provide.
...
To give a taste of the difference between HPC and regular computers, an HPC cluster can be 1 million times faster than the fastest laptop, [according to IBM](https://www.ibm.com/think/topics/supercomputing).
